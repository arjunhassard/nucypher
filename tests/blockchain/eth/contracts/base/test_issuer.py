...
def test_issuer(testerchain, token, deploy_contract):
    ...
    assert issuer.functions.currentSupply1().call() < first_phase_total_supply and \
        issuer.functions.currentSupply2().call() < first_phase_total_supply
    assert issuer.functions.currentSupply1().call() + max_first_phase_reward >= first_phase_total_supply or \
        issuer.functions.currentSupply2().call() + max_first_phase_reward >= first_phase_total_supply
...
def test_issuance_first_phase(testerchain, token, deploy_contract):
    ...
    assert current_supply_1 < first_phase_total_supply and current_supply_2 == first_phase_total_supply or \
        current_supply_1 == first_phase_total_supply and current_supply_2 < first_phase_total_supply
