...
def test_issuer(testerchain, token, deploy_contract):
    ...
    assert issuer.functions.currentSupply1().call() < economics.first_phase_supply and \
        issuer.functions.currentSupply2().call() < economics.first_phase_supply
    assert issuer.functions.currentSupply1().call() + economics.first_phase_stable_issuance >= economics.first_phase_supply or \
        issuer.functions.currentSupply2().call() + economics.first_phase_stable_issuance >= economics.first_phase_supply
...
def test_issuance_first_phase(testerchain, token, deploy_contract):
    ...
    current_supply_1 = issuer.functions.currentSupply1().call()
    current_supply_2 = issuer.functions.currentSupply2().call()
    assert current_supply_1 < economics.first_phase_supply and current_supply_2 == economics.first_phase_supply or \
        current_supply_1 == economics.first_phase_supply and current_supply_2 < economics.first_phase_supply
